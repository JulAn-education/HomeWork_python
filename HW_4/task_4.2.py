...
# поэтому ко времени сбора на них выросло различное число ягод – на i-ом кусте выросло ai ягод. Собирающий модуль за один заход, 
...
import random
berr = list(random.randint(1, 10) for _ in range(int(input('Сколько кустов на грядке: '))))
print(berr)
if len(berr) == 1:
    print(berr[0])
elif len(berr) == 2:
